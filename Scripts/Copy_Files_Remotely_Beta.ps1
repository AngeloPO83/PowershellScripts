 ...
 **Sorry about the identation, I'll fix it as soon as possible
#>
...
$ShowHelp={
   Switch ($this.name) {
    ...
    "iconInfoBox" {$tip = "Copy Files Remotely - Beta`nCreated by Angelo Polatto - 2019`nThis software was developed using Powershell ISE V5,`ncapable of listing and copy files from a remote computer,`nas long it runs Powershell V2 or more recent versions."}
    "LabelHiddenCheckBox" {$tip = "Selecting this option the software will list an hidden objects, excluding system files and folders.`nNonetheless it's a time consuming operation."}
    "HiddenCheckBox" {$tip = "Selecting this option the software will list hidden objects, excluding system files and folders.`nNonetheless it's a time consuming operation."}
...
$iconBase64      = ''
...
$Global:Panel1.add_paint({$whitePen = new-object System.Drawing.Pen([system.drawing.color]::gray, 3)
...
$Panel2.add_paint({$whitePen = new-object System.Drawing.Pen([system.drawing.color]::gray, 3)
$_.graphics.drawrectangle($whitePen,$this.clientrectangle)
})
...
$labelExclude.add_MouseHover($ShowHelp)
...
$LabelHiddenCheckBox.add_MouseHover($ShowHelp)
...
$HiddenCheckBox.add_MouseHover($ShowHelp)
...
$ButtonDestination.add_MouseHover($ShowHelp)
...
$computerIconBase64 = ''
$hddIconBase64 = ''
$folderIconBase64 = 'iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABmJLR0QA/wD/AP+gvaeTAAAAX0lEQVQ4y2NgoBRMq3L5j45n1Lr2kmTA7Q2pcHx1TfL/BU2eX2bWuPSRZQAIH1sY839uvedfbK5Dx1i9sKjZ+//5tVn/P59t+f/1XCtODDcAn6JRA0YNINoASjDFuRkAxodhfkNCKZEAAAAASUVORK5CYII='
$selectedFolderIconBase64 = ''
$fileIconBase64 = 'iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABmJLR0QA/wD/AP+gvaeTAAAAXElEQVQ4y2NggIKK7jn/8eHa/gVXGPABkCJcACTXM3f1/9qJ8y+QbcC37z/+989b+6+2H4chhAwAgS/fvv/vmbPqX92EBcdJNgAdk2QANgNHDRg1AKcBpGAGagEAEhhnW3BRVwEAAAAASUVORK5CYII='
$selectedIconBase64 = ''
...
$stream = New-Object IO.MemoryStream($selectedFolderIconBytes, 0, $selectedFolderIconBytes.Length)
...
$ArrayObjectsToCopy = [System.Collections.ArrayList]::Synchronized((New-Object System.Collections.ArrayList)) 
$ArrayRenameObjects = [System.Collections.ArrayList]::Synchronized((New-Object System.Collections.ArrayList)) 
...
Function mountRemoteTree ($exception, $query){
   ...
   $Global:powershell = [PowerShell]::Create().AddScript({
      ...
      $Hash.SplittedArray = Invoke-Command $Hash.session -ArgumentList $exception, $query -ScriptBlock {
         param($exception, $query)
         ...
         $objDriveLetters = GET-WMIOBJECT –query "SELECT * from win32_logicaldisk where Drivetype=3"
         ...
         ForEach($FSOBject in Get-Variable -name "ArrayFSObject$i" | % Value){
            if ($FSOBject.PSParentPath -eq ''){
               if($syncHash.tree.nodes.Count -eq 0 ){
                  [void]$syncHash.Tree.Nodes.Add($syncHash.treesub.nodes.Add($computerName,$computerName))
               ...
               if($syncHash.tree.nodes.Count -eq 1 ){
                  [void]$syncHash.treesub.Nodes[$computername].nodes.Add($syncHash.treesub.nodes.Add($FSObject.fullName, $FSObject.Name))
               ...
               if($FSOBject.mode -notmatch 'd'){
                  ...
                  [void]$syncHash.treesub.Nodes[$name].Nodes.Add($syncHash.treesub.nodes.Add($FSObject.FullName, $FSObject.Name))
...
Function copyObjects {
   ...
   $Runspace.ThreadOptions = "ReuseThread"
   $Runspace.Open()
   $SyncHash = [hashtable]::Synchronized(@{TextBox = $RichTextBox1; ProgressBar = $progressBar; LabelProgressBar = $labelProgressBar; ProgressBarFile = $progressBarFile; LabelProgressBarFile = $labelProgressBarFile; labelFileSize = $labelFileSize; labelTotalFileSize = $labelTotalFileSize; labelpartialCopyBytes=$labelpartialCopyBytes; labelOf=$labelOf })
   $Runspace.SessionStateProxy.SetVariable("SyncHash", $SyncHash)          
   $Runspace.SessionStateProxy.SetVariable("Hash", $Hash)    
   ...
   $Global:powershell = [PowerShell]::Create().AddScript({
         ...
         if($mode -notmatch 'd'){
            if((Test-Path $destination -PathType Leaf) -eq $false){
               try{
                  ...
                  $SyncHash.TextBox.AppendText("Failed to open write the file, " + $destination +" error: " + $error.exception.message + "`r`n")
               }
               if($error.count -eq 0){
                  ...
                  Invoke-Command -Session $Hash.session -ArgumentList $source -ScriptBlock{
                     ...
                     if($_.count -ge 0){
                        ...
                        $errorFlag = $true
                        $syncHash.TextBox.SelectionColor ="Red"
                        $SyncHash.TextBox.AppendText("`r`nFailed to copy, $($destination), $($_.exception.message)" + "`r`n")
                        $writer.close()
                        $writer.dispose()
                     ...
                     $syncHash.TextBox.SelectionColor ="Red"
                     $SyncHash.TextBox.AppendText("A failure occurred on the active session, $($hash.session.state), $($_.exception.message)" + "`r`n")
                  }
               }
               ...
               $syncHash.TextBox.SelectionColor ="Red"
               $SyncHash.TextBox.AppendText("File $($destination) already exists at destination."+ "`r`n")
            }
         }else{
            if((Test-Path $destination -PathType Container) -eq $false){
               ...
               $syncHash.TextBox.SelectionColor ="Red"
               $SyncHash.TextBox.AppendText("Folder $($destination) already exists at destination." + "`r`n")
               $counter++
               $SyncHash.progressBarFile.PerformStep()
               $percentage = [math]::floor(($counter/$totalChunks) * 100)
               $SyncHash.LabelProgressBarFile.text = "$($percentage)%"
      ...
      ForEach($object in $ArrayRenameObjects){
         ...
         ForEach-Object {
            if($_.exception){
               $syncHash.TextBox.SelectionColor ="Red"
               $SyncHash.TextBox.AppendText("Error trying to rename the object, " + $_.exception.message + "`r`n")
            }else{
               $syncHash.TextBox.SelectionColor ="Blue"
               $SyncHash.TextBox.AppendText("An object equal or greater than 247 characters was found, renaming it." + "`r`n") 
...
Function createSession{
   if ($Hash.session = New-PSSession -ComputerName $Global:computerName -ErrorAction SilentlyContinue){
      $RichTextBox1.AppendText("The remote session $($Hash.session) to $($Global:computerName) was successfuly created." + $nl)
...
Function removeSession{
   if (Remove-PSSession -session $Hash.session -ErrorAction SilentlyContinue){
      ...
      $RichTextBox1.AppendText("The remote session $($Hash.session) to $($Global:computerName) was successfuly removed." + $nl)
      $RichTextBox1.ScrollToCaret()
   }
}
...
Function addEventViewer($localComputer, $user, $domain, $date){
   Invoke-Command $hash.session -ArgumentList $localComputer, $user, $domain, $date -ScriptBlock {
      ...
      if([System.Diagnostics.EventLog]::SourceExists('Copy Files Remotely') -eq $false){
         ...
         Write-EventLog –LogName Application –Source "Copy Files Remotely" –EntryType Information –EventID 1  -Message "The software Copy Files Remotely - Beta was used on this computer by $($user)@$($domain), logged remotely on $($localComputer) at $($date)."
      }else{
         Write-EventLog –LogName Application –Source "Copy Files Remotely" –EntryType Information –EventID 1  -Message "The software Copy Files Remotely - Beta was used on this computer by $($user)@$($domain), logged remotely on $($localComputer) at $($date)." 
      }
   }
   ...
   if($_.Action -ne 'Unknown'){
      if ($labelDestination.Text -eq '...'){
         ...
         if($_.node.text -eq $computerName -or $_.node.text -match ':'){
            ...
            $Runspace.ThreadOptions = "ReuseThread"
            $Runspace.Open()
            $SyncHash = [hashtable]::Synchronized(@{ Tree = $global:tree; labelTotalFileSize = $labelTotalFileSize})
            $Runspace.SessionStateProxy.SetVariable("SyncHash", $SyncHash)
            $Runspace.SessionStateProxy.SetVariable("Hash", $Hash) 
            $Runspace.SessionStateProxy.SetVariable("ArrayObjectsToCopy", $ArrayObjectsToCopy) 
            $Runspace.SessionStateProxy.SetVariable("ArrayRenameObjects", $ArrayRenameObjects)
               ...
               Function checkAllChildNodes($treenode, $bool, $destination){
                  function renameNode($treenode){
                     ...
                     if($treenode.tag -notmatch 'd'){ 
                        ...
                        $lastItem = $lastItem.substring(0,7) + $randomNum + "_Renamed" + $extension
                     }else{
                        $randomNum = Get-Random -Maximum 9999
                        $lastItem = $lastItem.substring(0,7) + $randomNum + "_Renamed"
                     }
            ...
            }).AddArgument($_.node).AddArgument($_.node.checked).AddArgument($Global:folderPath)
            $Global:powershell.Runspace = $Runspace
            $Global:AsyncObject =  $Global:powershell.BeginInvoke()
            $global:currentRunspace  = $Runspace.id
            do{ 
...
$ButtonCopy_Click = {
   if ($labelDestination.Text -eq '...'){
      ...
      if($hash.session.State -eq 'Opened'){
         ...
         addEventViewer $env:COMPUTERNAME $env:USERNAME ($env:USERDNSDOMAIN).ToLower() $date
         copyObjects
      }else{
         $RichTextBox1.SelectionColor = 'Red'
      ...
      $RichTextBox1.AppendText("--------------------------------------------------------------------" + $nl)
      $RichTextBox1.SelectionColor = 'Green'
      $RichTextBox1.AppendText("Copy ended at " + $endCopy + ", it took " + $timeCopy + " to finish." + $nl)
      $RichTextBox1.ScrollToCaret()
   }else{
      $wshell = New-Object -ComObject Wscript.Shell
...
$ButtonComputer_Click = {
   clearVariables
   $Global:computerName  = [Microsoft.VisualBasic.Interaction]::InputBox("Type the computer's name.","Alert")
   ...
   if ([string]::IsNullOrWhitespace($Global:computerName)){ 
      ...
      if (Test-Connection $Global:computerName -count 1 -Quiet){
         ...
         $RichTextBox1.AppendText("--------------------------------------------------------------------" + $nl)
         $RichTextBox1.ScrollToCaret()
         $RichTextBox1.AppendText("It was possible to ping $($Global:computerName) successfuly." + $nl)
         if(Test-WSMan -ComputerName $Global:computerName -ErrorAction SilentlyContinue){
            $RichTextBox1.AppendText("It was possible to connect remotely to $($Global:computerName)." + $nl)
            createSession 
            if($hash.session.State -eq 'Opened'){
               $RichTextBox1.AppendText("Creating remote tree in $($Global:computerName), please wait... $($nl)")
               $include = @()
               ($TextBox1.Text).split(",") | % {
               ...
               if([string]::IsNullOrWhitespace($include)){
                  ...
                  foreach ($i in $include) {
                     if($count -eq 0) {
                        ...
                        $filter = $([string]::Format('{0} -or {1} -match "{2}"', $filter, $varnametocompare, $i))
                     }
                  }
               ...
               enableDisableButtons $true
               $RichTextBox1.AppendText("Remote tree was created in $($performance_1.minutes):$($performance_1.seconds):$($performance_1.milliseconds). $($nl)")
               ...
               if($hash.SplittedArray.count -gt 0 ){
                  ...
                  enableDisableButtons $true
                  $RichTextBox1.AppendText("Remote tree objects were recovered in $($performance_2.minutes):$($performance_2.seconds):$($performance_2.milliseconds). $($nl)")
                  $RichTextBox1.AppendText("Remote tree mounted locally in $($hash.performance_3.minutes):$($hash.performance_3.Seconds):$($hash.performance_3.milliSeconds). $($nl)")
               }else{
                  $RichTextBox1.SelectionColor = 'Red'
                  $RichTextBox1.AppendText("Was not possible to assemble the remote tree locally. $($nl)")
               }
            }else{
               $RichTextBox1.SelectionColor = 'Red'
               $RichTextBox1.AppendText("The session state wasn't opened, please wait. $($nl)")
            ...
            $Global:tree.Add_AfterCheck($TV_AfterCheck)
            $RichTextBox1.ScrollToCaret()
         }else{
            $RichTextBox1.SelectionColor = 'Red'
         ...
         $labelComputer.Text = '...'
         $RichTextBox1.SelectionColor = 'Red'
         $RichTextBox1.AppendText("Was not possible to establish a connection to the remote host, check the computer's name, $($Global:computerName)." + $nl)
         $RichTextBox1.ScrollToCaret()
      }
   }
}
...
$ButtonDestination_Click = {
   $FolderBrowser = New-Object System.Windows.Forms.FolderBrowserDialog -Property @{RootFolder = 'Desktop'}
...
$ButtonDestination.add_Click($ButtonDestination_Click)
$ButtonCopy.add_Click($ButtonCopy_Click)

[void]$form.Controls.AddRange(@($Global:Panel1, $Panel2, $iconInfoBox, $ButtonCopy, $ButtonDestination, $ButtonComputer, $ButtonStop, $labelFolder, $TextBox1, $labelExclude , $labelOutput, $labelDestination, $labelComputer, $labelProgressBar, $LabelHiddenCheckBox, $progressBar, $labelProgressBarFile, $progressBarFile, $labelLine, $labelProgressBarText, $labelProgressBarFileText, $labelFileSize, $labelTotalFileSize, $labelpartialCopyBytes, $labelOf, $HiddenCheckBox))
